...
class Settings(BaseSettings):
    ...
    POSTGRES_USER: str = "echoplan"
    POSTGRES_PASSWORD: str = "S3cur3P4ssw0rd"
    POSTGRES_DB: str = "echoplan"

    # Redis Settings
    REDIS_URL: str = "redis://redis:6379/0"

    # Mail Settings
    MAIL_USERNAME: str = "no-reply@echoplan.com"
    MAIL_PASSWORD: str = "S3cur3M4!lP@ssw0rd"
    MAIL_FROM_NAME: str = "EchoPlan"
    MAIL_PORT: int = 587
    MAIL_SERVER: str = "mail.echoplan.com"
